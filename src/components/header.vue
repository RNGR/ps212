<template>
  <div>
      ...
      <div class="container">
        ...
        <nav class="h6">
          ...
          >
            <path
              fill="#263238"
              d="M294,43 L324,43 L324,46 L294,46 L294,43 Z M294,51 L324,51 L324,54 L294,54 L294,51 Z M294,59 L324,59 L324,62 L294,62 L294,59 Z"
              transform="translate(-294 -43)"
            />
          </svg>
        </nav>
      </div>
    ...
    <div id="menu" v-bind:class="{ active: showMobileMenu }">
      ...
      ><br />
      <router-link to="/work" v-on:click.native="showMobileMenu = false"
        >Work</router-link
      ><br />
      <router-link to="/news" v-on:click.native="showMobileMenu = false"
        >News</router-link
      ><br />
